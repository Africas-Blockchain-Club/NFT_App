module.exports = [
"[project]/.next-internal/server/app/api/users/signup/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/database.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const DB_PATH = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'data', 'users.json');
// Initialize database
const initializeDB = ()=>{
...
const saveUser = (user)=>{
    ...
    users.push(user);
    __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(DB_PATH, JSON.stringify(users, null, 2));
};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/database.ts [app-route] (ecmascript)");
;
;
async function POST(request) {
    try {
        ...
        // Save to database
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUser"])(user);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4089eec9._.js.map