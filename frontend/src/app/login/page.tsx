      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-500 p-6 text-center">
            ...
            <p className="text-white/80 mt-2">Sign in to support your favorite charities</p>
          </div>
          
          <div className="p-8">
            {error && (
              <div className="bg-red-500/10 border border-red-500/20 text-red-500 px-4 py-3 rounded-lg mb-6 flex items-center">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="bg-white/5 border border-white/10 text-white placeholder-gray-400 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent block w-full pl-10 p-3"
            ...
            <div className="mt-8 text-center">
              <p className="text-white/70">
                ...
                <Link href="/signup" className="font-medium text-purple-300 hover:text-white transition">
                  Sign up
                </Link>
              </p>
              
              <p className="mt-4">
                <Link href="/" className="text-purple-300 hover:text-white transition flex items-center justify-center">
