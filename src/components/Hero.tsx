      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 mb-10 md:mb-0 relative z-10">
          <h1 className="text-5xl font-bold text-gray-900 leading-tight mb-6">
            Support Charities with <span className="text-black bg-gradient-to-r from-pink-600 to-pink-800 px-2 rounded-lg shadow-lg">Zero-Friction</span> NFT Purchases
          </h1>
